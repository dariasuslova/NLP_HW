...
from nltk import word_tokenize #улучшение препроцессинга
from nltk.stem.wordnet import WordNetLemmatizer #улучшение препроцессинга

lmtzr = WordNetLemmatizer() #улучшение препроцессинга
...
def separate_words(text, min_word_return_size):
    ...
    words = []
    tokens = word_tokenize(text) #улучшение препроцессинга
    lemmas = [lmtzr.lemmatize(t) for t in tokens] #улучшение препроцессинга
